...
5. If you know how, fork the repo and create a pull request. If not, then send the translation file to @prodeode or @mildlydepressed on Discord, and they will add it for you.
